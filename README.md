...
There are docker container(s) that are prerequisites for running the cardboard app. You can start and stop them with:
...
You create a new card by running the generator in the `cardboard/` directory of the project:
```
